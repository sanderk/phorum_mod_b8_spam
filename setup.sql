...
CREATE TABLE `b8_messages` (
  `id` integer auto_increment,
  `text` text character set utf8 collate utf8_bin NOT NULL,
  `classification` enum('SPAM','HAM'),
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `b8_messages` (`text`, `classification`) VALUES ('buy my nice watches', 'SPAM');
INSERT INTO `b8_messages` (`text`, `classification`) VALUES ('buy my house', 'HAM');
